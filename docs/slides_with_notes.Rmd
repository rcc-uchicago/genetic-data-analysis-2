...
+ All the examples are intended to run on your laptop or on the RCC
  cluster.
...
mapping resolution will not be as good as human GWAS.

+ Unlike most human GWAS, data are publicly available.

> Instructor notes: We will see that <10% of the effort is running
GEMMA; *we will spend most of our time preparing the data for GEMMA,
and examining the GEMMA output in R.*
