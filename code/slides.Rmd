...
Explore the data in R (part 5)
==============================

Examine the relationship between tibia length and body weight (at
dissection):

```{r plot-tibia-vs-weight}
p2 <- draw.scatterplot(pheno$Tibia.Length,pheno$Weight.Diss) +
  labs(x = "tibia length (mm)",y = "body weight (g)")
print(p2)
```
