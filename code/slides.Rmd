...
file in the* `output` *directory containing the results of this analysis.*
...
Follow the same steps as before to load the GEMMA results and create
a genomic inflation plot:
