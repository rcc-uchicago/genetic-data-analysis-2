...
+ LMMs are now one of the most widely used approaches to reduce inflation

+ However, computationally intensive.

+ Also, LMMs can overcorrect inflation; this is particularly a problem
in mouse GWAS due to long-range LD patterns, so a
"leave-one-chromosome-out" strategy is often taken to prevent
*deflation* of small $p$-values.
...
plot" showing the results of our genome-wide association analysis. It
takes as input a table of GEMMA association results:
